...
try {
    ...
    // ── READ (happy scenario) ─────────────────────────────────────────
    // Lees de reservering uit de database. Bestaat hij en is hij nog
    // annuleerbaar, dan gaat de flow verder naar het annuleren.
    ...
    if (!$reservering) {
        ...
        // De reservering bestaat niet (meer) of is al verwerkt:
        // geef een duidelijke 404 terug in plaats van te crashen.
        $pdo->rollBack();
