...
try {
    ...
    $stats = [
        'totaal_voorstellingen'    => '350+',
        'totaal_klanten'           => '120K',
        'bevestigde_reserveringen' => '25+',
        'totaal_omzet'             => null,
    ];
}
?>
...
<header class="header">
    <nav class="nav container">
        ...
        <div class="nav-actions">
            <a href="ticket overzicht/index.php" class="btn btn--ghost">Mijn Tickets</a>
...
<section id="stats" class="stats">
    ...
    <div class="stat">
        <h3><?= isset($stats['totaal_klanten']) && is_numeric($stats['totaal_klanten'])
    ...
    <div class="stat">
        <h3><?= isset($stats['totaal_voorstellingen']) && is_numeric($stats['totaal_voorstellingen'])
