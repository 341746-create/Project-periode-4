-- =====================================================================
-- database.sql
-- Project: projectperiode4
--   - User Story 121 "Nieuwe Medewerker Toevoegen"
--   - User Story 49  "Overzicht Medewerkers"
--
-- Doel: één gedeelde database "personeelsbeheer" voor beide user
-- stories. US121: een administrator kan een nieuwe medewerker
-- toevoegen aan het systeem. US49: een administrator kan een
-- overzicht van alle medewerkers bekijken (incl. hun gegevens),
-- zodat er inzicht is in alle medewerkers binnen de applicatie.
--
...
-- =====================================================================
-- Voorbeeldquery's passend bij User Story 49 "Overzicht Medewerkers"
-- =====================================================================

-- Scenario 1: volledig overzicht van alle medewerkers met hun gegevens,
-- zoals getoond op de "Overzicht medewerkers"-pagina.
-- SELECT m.medewerker_id, m.personeelsnummer, m.voornaam, m.achternaam,
--        m.email, m.telefoonnummer, a.naam AS afdeling, f.titel AS functie,
--        m.status, m.datum_in_dienst
-- FROM medewerkers m
...
-- Filteren op afdeling, zoals een administrator zou doen op het dashboard:
-- SELECT * FROM medewerkers WHERE afdeling_id = 1;
